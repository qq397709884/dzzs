...
<title>电子证书管理平台</title>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
<link rel="stylesheet" href="${ctx}/scripts/font-awesome/css/font-awesome.min.css">
<link rel="stylesheet" href="${ctx}/scripts/ionicons/css/ionicons.min.css">
<link rel="stylesheet" href="${ctx}/scripts/dist/css/zflow.min.css">
<link rel="stylesheet" href="${ctx}/scripts/dist/css/skins/_all-skins.min.css">
<!--[if lt IE 9]>
<script type="text/javascript" src="${ctx}/scripts/html5shiv/html5shiv.min.js"></script>
<script type="text/javascript" src="${ctx}/scripts/respond/respond.min.js"></script>
<![endif]-->
<link rel="stylesheet" href="${ctx}/scripts/bootstrap/css/bootstrap.css"/>
...
<script type="text/javascript" src="${ctx}/scripts/jquery/jquery-1.11.3.js"></script>
<script type="text/javascript" src="${ctx}/scripts/bootstrap/js/bootstrap.js"></script>
